...
Учебное приложение, которое было написано в первые несколько недель работы в [Progressive Mobile][ProgressiveMobile]. Основной его целью было научиться основным практикам/приёмам, существующих в организации перед тем как присоеденятся к боевому проекту.

Приложение является подобием мобильной версии интернет магазина. Доступны следующие сценарии:
1) Авторизация. Для входа  можно ввести что угодно.
![auth demo][AuthDemo]
...
Ключевые особенности:
  ...
  - Кэширование получаемой информации c mockable в sqlite
  -
  - Динамическая смена темы приложения
